...
export default function ForgotPasswordForm({ onResetSubmit, onBackToLogin, isSubmitting, resetSent, setResetSent }: ForgotPasswordFormProps) {
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              {error && (
                <span className="text-xs text-rose-455 font-medium">{error}</span>
              )}
            </div>
            <input 
