...
import { DataCard, DataRow, StatusIndicator, MetricsGrid, ActionPanel } from '../../packages/vyzorix/src/index';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          <DataCard title="Active Node Activity" badge="Live">
            <DataRow label="Region: Paris, FR" value={<StatusIndicator status="active" label="Operational" />} />
            <DataRow label="Region: Frankfurt, DE" value={<StatusIndicator status="active" label="Operational" />} />
            <DataRow label="Region: Singapore, SG" value={<StatusIndicator status="standby" label="Standby" />} />
            <DataRow label="Region: Tokyo, JP" value={<StatusIndicator status="offline" label="Maintenance" />} />
          </DataCard>
        </div>
