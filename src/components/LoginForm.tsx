...
export default function LoginForm({ onLogin, onSSO, onForgotPassword, isSubmitting }: LoginFormProps) {
  ...
  return (
    <div id="login-form-container">
      <div className="mb-8 text-center md:text-left">
        <h1 className="text-2xl md:text-3xl font-semibold text-white tracking-tight">Welcome back</h1>
        <p className="text-slate-400 text-sm mt-2">
          Access your authorized database workspace.
        </p>
      </div>
