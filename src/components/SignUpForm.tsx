...
export default function SignUpForm({ onSignUp, onSSO, isSubmitting, triggerToast }: SignUpFormProps) {
  ...
  return (
    <div id="signup-form-container">
      <div className="mb-8 text-center md:text-left">
        <h1 className="text-2xl md:text-3xl font-semibold text-white tracking-tight">Get an operator account</h1>
      </div>
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        {/* Sign up Terms Checkbox - do not touch term contents */}
        <div className="flex items-start gap-3 pt-2">
          ...
          <div className="flex flex-col">
            <label className="text-slate-350 text-xs cursor-pointer select-none leading-relaxed" htmlFor="terms">
              I agree to the <a className="text-rose-455 hover:text-rose-300 font-semibold underline underline-offset-2" href="#terms" onClick={(e) => { e.preventDefault(); triggerToast("Agreement recorded successfully.", "success"); }}>Terms of Service</a> and <a className="text-rose-455 hover:text-rose-300 font-semibold underline underline-offset-2" href="#privacy" onClick={(e) => { e.preventDefault(); triggerToast("No tracking cookies saved.", "success"); }}>Privacy Policies</a>.
            </label>
            {errors.terms && (
        ...
        {/* SSO Choices in custom corporate styling */}
